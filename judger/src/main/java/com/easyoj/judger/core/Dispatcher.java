...
import com.easyoj.judger.model.Checkpoint;
...
import com.easyoj.judger.application.ApplicationDispatcher;
import com.easyoj.judger.exception.IllgealSubmissionException;
import com.easyoj.judger.mapper.CheckpointMapper;
import com.easyoj.judger.mapper.SubmissionMapper;
...
public class Dispatcher {
	...
	public void createNewTask(long submissionId) throws IllgealSubmissionException, InterruptedException {
		synchronized(this) {
			String baseDirectory = String.format("%s/eoj-%s", new Object[] {workBaseDirectory, submissionId});
