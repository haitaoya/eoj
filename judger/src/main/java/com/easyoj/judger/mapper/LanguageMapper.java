...
public interface LanguageMapper {
	 ...
	 */
	@Select("SELECT * FROM eoj_languages WHERE language_id = #{languageId}")
	 ...
	 * @return 预期的编程语言对象或空引用
	 */
	@Select("SELECT * FROM eoj_languages WHERE language_slug = #{languageSlug}")
	@Options(useCache = true)
	@Results({
		 @Result(property = "languageId", column = "language_id"),
		 @Result(property = "languageSlug", column = "language_slug"),
	 ...
	 */
	@Select("SELECT * FROM eoj_languages")
	@Options(useCache = true)
	@Results({
		 @Result(property = "languageId", column = "language_id"),
		 @Result(property = "languageSlug", column = "language_slug"),
