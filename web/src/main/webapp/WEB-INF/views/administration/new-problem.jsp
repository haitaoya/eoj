...
<body>
    <div id="wrapper">
        ...
        <div id="container">
            ...
            <!-- Content -->
            <div id="content">
                <h2 class="page-header"><i class="fa fa-file"></i> 创建试题</h2>
                        ...
                        <div class="span4">
                            <div class="section">
                                ...
                                <div class="footer text-right">
                                    <button class="btn btn-primary" type="submit">创建试题</button>
                                </div> <!-- .footer -->
                            </div> <!-- .section -->
                            <div class="section">
                                <div class="header">
                            ...
                            <div class="section">
                                ...
                                <div class="body">
                                    <input id="problem-tags" class="tagsinput" type="hidden" value="无" />
                                </div> <!-- .body -->
                            </div> <!-- .section -->
                        </div> <!-- .span4 -->
                    </div> <!-- .row-fluid -->
    ...
    <script type="text/javascript">
        function processCreateProblemResult(result) {
            if ( result['isSuccessful'] ) {
                ...
                $('.alert-success','#problem-form').html("创建成功"+"<a href='web/p/"+problemId+"'>查看试题</a>");
            ...
            $('button[type=submit]', '#problem-form').html('创建试题');
        }
    </script>
</body>
</html>