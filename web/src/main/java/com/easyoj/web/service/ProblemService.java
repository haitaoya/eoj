...
import com.easyoj.web.mapper.CheckpointMapper;
import com.easyoj.web.mapper.ProblemCategoryMapper;
import com.easyoj.web.mapper.ProblemMapper;
import com.easyoj.web.mapper.ProblemTagMapper;
...
public class ProblemService {
	...
	public Map<Long, List<ProblemCategory>> getProblemCategoriesOfProblems(
			...
			long offset, String keyword, String problemCategorySlug,
			String problemTagSlug, boolean isPublicOnly, int limit) {
		ProblemCategory problemCategory = problemCategoryMapper.getProblemCategoryUsingCategorySlug(problemCategorySlug);
		ProblemTag problemTag = problemTagMapper.getProblemTagUsingTagSlug(SlugifyUtils.getSlug(problemTagSlug));
		int problemCategoryId = 0;
		...
		List<ProblemCategoryRelationship> problemCategoryRelationships =
				problemCategoryMapper.getProblemCategoriesOfProblems(/* problemIdLowerBound, problemIdUpperBound */keyword, problemCategoryId, problemTagId, isPublicOnly, offset, limit);
	...
	public Map<Long, List<ProblemTag>> getProblemTagsOfProblems(
		...
		List<ProblemTagRelationship> problemTagRelationships =
				problemTagMapper.getProblemTagsOfProblems(/* problemIdLowerBound, problemIdUpperBound */keyword, problemCategoryId, problemTagId, isPublicOnly, offset, limit);
